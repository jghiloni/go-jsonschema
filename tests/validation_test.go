...
import (
	...
	testExclusiveMaximum "github.com/jghiloni/go-jsonschema/tests/data/validation/exclusiveMaximum"
	testExclusiveMinimum "github.com/jghiloni/go-jsonschema/tests/data/validation/exclusiveMinimum"
	testMaxLength "github.com/jghiloni/go-jsonschema/tests/data/validation/maxLength"
	testMaximum "github.com/jghiloni/go-jsonschema/tests/data/validation/maximum"
	testMinLength "github.com/jghiloni/go-jsonschema/tests/data/validation/minLength"
	testMinimum "github.com/jghiloni/go-jsonschema/tests/data/validation/minimum"
	testMultipleOf "github.com/jghiloni/go-jsonschema/tests/data/validation/multipleOf"
	testPattern "github.com/jghiloni/go-jsonschema/tests/data/validation/pattern"
	testPrimitiveDefs "github.com/jghiloni/go-jsonschema/tests/data/validation/primitive_defs"
	testReadOnlyFields "github.com/jghiloni/go-jsonschema/tests/data/validation/readOnly"
	testReadOnlyAndRequiredFields "github.com/jghiloni/go-jsonschema/tests/data/validation/readOnlyAndRequired"
	testRequiredFields "github.com/jghiloni/go-jsonschema/tests/data/validation/requiredFields"
	testReadOnlyValidationDisabledFields "github.com/jghiloni/go-jsonschema/tests/data/validationDisabled/readOnly"
	"github.com/jghiloni/go-jsonschema/tests/helpers"
)
